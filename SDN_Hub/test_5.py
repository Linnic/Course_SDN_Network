...
"""
*  This is an emulation about 1 Router(router_1), 1 Bridege(bridge_1),
*   4 Hosts(host_1, host_2, host_3, host_4), and 2 Groups(mybr_10, mybr_20),
...
if '__main__' == __name__:
    ...
    bridge_1.cmd('ifconfig bridge_1-eth5 0')
    ...
    bridge_1.cmd("brctl addif mybr_10 bridge_1-eth4")
    bridge_1.cmd("brctl addif mybr_20 bridge_1-eth2")
    bridge_1.cmd("brctl addif mybr_20 bridge_1-eth3")
    bridge_1.cmd("brctl addif mybr_20 bridge_1-eth5")
    bridge_1.cmd('ifconfig mybr_10 up')
    bridge_1.cmd('ifconfig mybr_20 up')

    router_1.cmd('ifconfig router_1-eth0 192.168.10.254 netmask 255.255.255.0')
    router_1.cmd('ifconfig router_1-eth1 192.168.20.254 netmask 255.255.255.0')
